(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["_kollektor"] = factory();
	else
		root["_kollektor"] = factory();
})(window, function() {
...
var Kollektor = (function () {
    ...
    Kollektor.prototype.analyseInteractionEvent = function (element, event) {
        ...
        if (!targetComponent)
            return;
        var res = new MouseInteraction_1.MouseInteraction(element, event, targetComponent, this.options.containers);
        if (res) {
    ...
    Kollektor.prototype.analyseScrollEvent = function (event) {
        ...
        passedScrollDistances.forEach(function (d) {
            if (!_this.trackedScrollDistances.includes(d)) {
                _this.forwardToConsumers(new ScrollInteraction_1.ScrollInteraction(d, event));
...
exports.register = function (options) {
    ...
    var improperConsumers = options.consumers.filter(function (c) { return !c.name || !c.map || !c.events || !c.handler; });
    if (improperConsumers.length != 0) {
        console.warn("Kollektor: all consumers must have a name, map, events and handler defined", {
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(0);
var BaseInteraction_1 = __webpack_require__(1);
var MouseInteraction = (function (_super) {
    tslib_1.__extends(MouseInteraction, _super);
    function MouseInteraction(element, e, target, containers) {
    ...
    MouseInteraction.prototype.populateNativeProperties = function () {
        return {
            id: this.element.id,
    ...
    MouseInteraction.prototype.populateData = function () {
        ...
        return {
            ...
            identifier: this.getIdentifier(element),
    ...
    MouseInteraction.prototype.getLabel = function (element) {
        if (this.matchedTarget.labelAttribute) {
            if (typeof (this.matchedTarget.labelAttribute) == "string") {
                ...
                return this.matchedTarget.labelAttribute(this.element);
            }
        }
    ...
    MouseInteraction.prototype.isLink = function () {
        var href = this.nativeProperties.href;
        return Boolean(href);
    };
    MouseInteraction.prototype.isOutbound = function () {
    ...
    MouseInteraction.prototype.getIdentifier = function (element) {
        if (this.matchedTarget.identifierAttribute) {
            if (typeof (this.matchedTarget.identifierAttribute) == "string") {
                ...
                return this.matchedTarget.identifierAttribute(this.element);
            }
        }
    ...
    MouseInteraction.prototype.getContainerObject = function () {
        var allMatches = [];
        var all = [];
        var res = {
            highest: "",
...
var ConfigurationTemplates_1 = __webpack_require__(6);
var bootstrap4_1 = __webpack_require__(7);
var Configuration = (function () {
    ...
    Configuration.prototype.mapCustomOptionsToConfiguration = function (options) {
        return {
            ...
            isDebug: options.isDebug || default_1.defaultTemplate.isDebug,
            privacy: options.privacy || default_1.defaultTemplate.privacy,
            ...
            consumers: options.consumers || default_1.defaultTemplate.consumers,
            scrollDistances: options.scrollDistances || default_1.defaultTemplate.scrollDistances
        };
    };
    Configuration.prototype.getTemplate = function (template) {
        switch (template) {
...
var tslib_1 = __webpack_require__(0);
var BaseInteraction_1 = __webpack_require__(1);
var ScrollInteraction = (function (_super) {
    tslib_1.__extends(ScrollInteraction, _super);
    function ScrollInteraction(scrollPercentage, event) {
    ...
    ScrollInteraction.prototype.populateData = function () {
        return;
    };
    return ScrollInteraction;
}(BaseInteraction_1.BaseInteraction));
exports.ScrollInteraction = ScrollInteraction;
