...
export class MouseInteraction extends BaseInteraction {
    private element: HTMLElement;
    private matchedTarget: ITarget;
    private matchedContainers: IContainer[];
    private nativeProperties: INativeProperties;
    private collectedProperties: IInteractionData;

    constructor(element: HTMLElement, e: MouseEvent, target: ITarget, containers: IContainer[]) {
        super(e);
     ...
     */
    private getIdentifier(element: HTMLElement): string {
